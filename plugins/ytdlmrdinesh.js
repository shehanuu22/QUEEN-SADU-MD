...
cmd({
  ...
  try {
    ...
    const _0x166c67 = await _0x5351f6.sendMessage(_0x14fac3, {
      ...
      'caption': "\n`🎶QUEEN SADU MD🎶`\n\n ━━━━━━━━━━━━━━━━━\n*⟣ qᴜᴇᴇɴ ꜱᴀᴅᴜ sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ⟢*\n━━━━━━━━━━━━━━━━━\n-  *ᴍʏ ᴄʜᴀɴɴᴇʟ*\n\n*https://whatsapp.com/channel/0029Vafn6hc7DAX3fzsKtn40*\n━━━━━━━━━━━━━━━━━━\n\n> ℹ️ ʀᴇᴘʟʏ ʙᴇʟᴏᴡ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ғᴏʀᴍᴀᴛ\n\n*1   ┃ ᴀᴜᴅɪᴏ sᴏɴɢ🎵*\n*2   ┃  ᴅᴏᴄᴜᴍᴇɴᴛ sᴏɴɢ🗂️*\n\n> © 2025 || ©𝐌𝐑 𝐃𝐈𝐍𝐄𝐒𝐇 𝐎𝐅𝐂\n"
    }, {
      'quoted': _0x1439a7
    });
      ...
      if (_0x3cf2a8) {
        ...
        if (_0x5f20ab === '1') {
          ...
          await _0x5351f6.sendMessage(_0x3277a3, {
            ...
            'caption': "\n> *© Gᴇɴᴇʀᴀᴛᴇᴅ ꜰᴏʀ ʏᴏᴜ Bʏ QUEEN SADU MD❤️*\n "
          }, {
            'quoted': _0x25ddf5
          });
          await _0x5351f6.sendMessage(_0x3277a3, {
...
cmd({
  ...
  try {
    ...
    const _0x51503b = await _0x2a6587.sendMessage(_0x2b34ab, {
      ...
      'caption': "\n*🎶QUEEN SADU-MD🎶* \n\n┏━━━━━━━━━━━━━\n┃qᴜᴇᴇɴ ꜱᴀᴅᴜ ᴍᴅ ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ ✻\n┗━━━━━━━━━━━━━\n┏━━━━━━━━━━━━━━\n\n🔢 *ʀᴇᴘʟʏ ʙᴇʟᴏᴡ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴛᴏ*\n*ᴅᴏᴡɴʟᴏᴀᴅ ꜰʀᴏᴍᴀᴛ*\n\n*ᴅᴏᴡɴʟᴏᴀᴅ ᴠɪᴅᴇᴏ 🎬*\n\n*1.1*     ┃  *360ᴘ*\n*1.2*     ┃  *480ᴘ*\n*1.3*     ┃  *720ᴘ*\n*1.4*     ┃  *1080ᴘ*\n\n*ᴅᴏᴡɴʟᴏᴀᴅ ᴅᴏᴄᴜᴍᴇɴᴛ 📁*\n\n*2.1*     ┃  *360ᴘ*\n*2.2*     ┃  *480ᴘ*\n*2.3*     ┃  *720ᴘ*\n*2.4*     ┃  *1080ᴘ*\n\n> ®ᴍʀ ᴅɪɴᴇꜱʜ ᴏꜰᴄ ✻\n"
    }, {
      'quoted': _0x4b0a32
    });
    ;
      ...
      if (_0x5e3294) {
        ...
        if (_0x1acf8d === "1.1") {
          ...
          await _0x2a6587.sendMessage(_0x5cd381, {
            ...
            'caption': "\n* Gᴇɴᴇʀᴀᴛᴇᴅ ꜰᴏʀ Yᴏᴜ Bʏ qᴜᴇᴇɴ ꜱᴀᴅᴜ❤️*\n"
          }, {
            'quoted': _0x3dce21
          });
          await _0x2a6587.sendMessage(_0x5cd381, {
            ...
            if (_0x1acf8d === "1.3") {
              ...
              if (_0x1acf8d === '1.4') {
                ...
                await _0x2a6587.sendMessage(_0x5cd381, {
                  ...
                  'caption': "\n*Gᴇɴᴇʀᴀᴛᴇᴅ ꜰᴏʀ Yᴏᴜ Bʏ queen sadu❤️*\n"
                }, {
                  'quoted': _0x3dce21
                });
                await _0x2a6587.sendMessage(_0x5cd381, {
                ...
                if (_0x1acf8d === "2.1") {
                  ...
                  await _0x2a6587.sendMessage(_0x5cd381, {
                    ...
                    'caption': "\n*Gᴇɴᴇʀᴀᴛᴇᴅ ꜰᴏʀ Yᴏᴜ Bʏ ᴍʀ ᴅɪɴᴇꜱʜ❤️*\n"
                  }, {
                    'quoted': _0x3dce21
                  });
                  await _0x2a6587.sendMessage(_0x5cd381, {
...
cmd({
  ...
  try {
    ...
    reply("*_QUEEN-SADU downloading your song...🔍_*");
